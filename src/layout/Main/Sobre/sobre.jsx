...
export default function Sobre () {
    return (
        ...
        <div className='overflow-hidden justify-content-around d-lg-flex bg-success mt-5'>
            <div className='p-5'>
            <h2 className='fw-bold mb-5 text-start fs-5'>Este projeto é open-source ou seja de código aberto se caso você se interessou pela ideia ou encontrou algum possível bug.</h2>
            <h2 className='fw-bold mb-5 text-start fs-5'>Entre em contato comigo ou faça uma PR (pull request) pro projeto.</h2>
